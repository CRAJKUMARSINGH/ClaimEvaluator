...
export enum ClaimCategory {
  ...
  EOT = 'eot',
  LOSS_OF_OPPORTUNITY = 'loss_of_opportunity',
 ...
 */
export const FIDIC_DELAY_TEMPLATE: ClaimTemplate = {
  id: 'fidic-delay-001',
 ...
 */
export const NHAI_VARIATION_TEMPLATE: ClaimTemplate = {
...
export const CLAIM_TEMPLATES: Record<string, ClaimTemplate> = {
  'fidic-delay-001': FIDIC_DELAY_TEMPLATE,
  'nhai-variation-001': NHAI_VARIATION_TEMPLATE
};

/**
 * Get template by ID
 */
export function getTemplate(templateId: string): ClaimTemplate | null {
  return CLAIM_TEMPLATES[templateId] || null;
}

/**
 * Get templates by category
 */
export function getTemplatesByCategory(category: ClaimCategory): ClaimTemplate[] {
  return Object.values(CLAIM_TEMPLATES).filter(t => t.category === category);
}

/**
 * Get templates by contract type
 */
export function getTemplatesByContract(contractType: string): ClaimTemplate[] {
  return Object.values(CLAIM_TEMPLATES).filter(t => 
    t.contractType.includes(contractType)
  );
}
